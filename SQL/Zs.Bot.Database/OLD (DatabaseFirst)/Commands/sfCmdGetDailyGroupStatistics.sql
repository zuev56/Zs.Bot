-- FUNCTION: cas."sfCmdGetDailyGroupStatistics"(integer, timestamp with time zone, timestamp with time zone)

-- DROP FUNCTION cas."sfCmdGetDailyGroupStatistics"(integer, timestamp with time zone, timestamp with time zone);

CREATE OR REPLACE FUNCTION cas."sfCmdGetDailyGroupStatistics"(
        rows_limit integer,
...
ALTER FUNCTION cas."sfCmdGetDailyGroupStatistics"(integer, timestamp with time zone, timestamp with time zone)
    OWNER TO postgres;

COMMENT ON FUNCTION cas."sfCmdGetDailyGroupStatistics"(integer, timestamp with time zone, timestamp with time zone)
    IS 'Возвращает статистику по сообщниям за день';
