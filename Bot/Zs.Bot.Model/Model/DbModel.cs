...
namespace Zs.Bot.Model.Db
{
    ...
    //{
    //    //public static bool SaveToDb(IUser user, ZsBotDbContext context)
    //    //{
    //    //    if (user == null)
    ...
    //    //}
    //
    //    //public static bool UpdateRawData(int userId, IUser newUser, ZsBotDbContext context)
    //    //{
    //    //    if (newUser is null)
    //    //        throw new ArgumentNullException(nameof(newUser));
    //                    
    //    //    var originalUser = context.Users.FirstOrDefault(u => u.UserId == userId);
    //
