    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "CHANNEL", new DateTime(2020, 9, 21, 22, 0, 32, 22, DateTimeKind.Local).AddTicks(3566), "Channel" },
                    { "GROUP", new DateTime(2020, 9, 21, 22, 0, 32, 22, DateTimeKind.Local).AddTicks(4309), "Group" },
                    { "PRIVATE", new DateTime(2020, 9, 21, 22, 0, 32, 22, DateTimeKind.Local).AddTicks(4316), "Private" },
                    { "UNDEFINED", new DateTime(2020, 9, 21, 22, 0, 32, 22, DateTimeKind.Local).AddTicks(4318), "Undefined" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "/Test", null, "Тестовый запрос к боту. Возвращает ''Test''", "moderatorCmdGroup", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(3900), "SELECT ''Test''" },
                    { "/NullTest", null, "Тестовый запрос к боту. Возвращает NULL", "moderatorCmdGroup", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(4437), "SELECT null" },
                    { "/Help", "<UserRoleCode>", "Получение справки по доступным функциям", "userCmdGroup", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(4928), "SELECT bot.sf_cmd_get_help({0})" },
                    { "/SqlQuery", "select ''Pass your query as parameter in double quotes''", "SQL-запрос", "adminCmdGroup", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(4935), "select (with userQuery as ({0}) select json_agg(q) from userQuery q)" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "OTH", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(266), "Other" },
                    { "SRV", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(262), "Service message" },
                    { "CNT", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(258), "Contact" },
                    { "LOC", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(253), "Location" },
                    { "STK", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(250), "Sticker" },
                    { "DOC", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(247), "Document" },
                    { "VID", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(243), "Video" },
                    { "AUD", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(241), "Audio" },
                    { "PHT", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(239), "Photo" },
                    { "TXT", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(234), "Text" },
                    { "UKN", new DateTime(2020, 9, 21, 22, 0, 32, 23, DateTimeKind.Local).AddTicks(9432), "Unknown" },
                    { "VOI", new DateTime(2020, 9, 21, 22, 0, 32, 24, DateTimeKind.Local).AddTicks(245), "Voice" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "TG", new DateTime(2020, 9, 21, 22, 0, 32, 19, DateTimeKind.Local).AddTicks(4725), "Telegram" },
                    { "VK", new DateTime(2020, 9, 21, 22, 0, 32, 20, DateTimeKind.Local).AddTicks(7569), "Вконтакте" },
                    { "SK", new DateTime(2020, 9, 21, 22, 0, 32, 20, DateTimeKind.Local).AddTicks(7589), "Skype" },
                    { "FB", new DateTime(2020, 9, 21, 22, 0, 32, 20, DateTimeKind.Local).AddTicks(7591), "Facebook" },
                    { "DC", new DateTime(2020, 9, 21, 22, 0, 32, 20, DateTimeKind.Local).AddTicks(7593), "Discord" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "MODERATOR", new DateTime(2020, 9, 21, 22, 0, 32, 23, DateTimeKind.Local).AddTicks(2200), "Moderator", "[ \"moderatorCmdGroup\", \"userCmdGroup\" ]" },
                    { "OWNER", new DateTime(2020, 9, 21, 22, 0, 32, 23, DateTimeKind.Local).AddTicks(1669), "Owner", "[ \"All\" ]" },
                    { "ADMIN", new DateTime(2020, 9, 21, 22, 0, 32, 23, DateTimeKind.Local).AddTicks(2195), "Administrator", "[ \"adminCmdGroup\", \"moderatorCmdGroup\", \"userCmdGroup\" ]" },
                    { "USER", new DateTime(2020, 9, 21, 22, 0, 32, 23, DateTimeKind.Local).AddTicks(2204), "User", "[ \"userCmdGroup\" ]" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -1, "PRIVATE", "UnitTestChat", new DateTime(2020, 9, 21, 22, 0, 32, 22, DateTimeKind.Local).AddTicks(8894), "UnitTestChat", "{ \"test\": \"test\" }", "-1063294487", null },
                    { 1, "PRIVATE", null, new DateTime(2020, 9, 21, 22, 0, 32, 22, DateTimeKind.Local).AddTicks(9449), "zuev56", "{ \"test\": \"test\" }", "-1063294487", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Сергей Зуев", new DateTime(2020, 9, 21, 22, 0, 32, 23, DateTimeKind.Local).AddTicks(7556), false, "zuev56", "{ \"test\": \"test\" }", "-1063294487", null, "ADMIN" },
                    { -10, "for exported message reading", new DateTime(2020, 9, 21, 22, 0, 32, 23, DateTimeKind.Local).AddTicks(7007), false, "Unknown", "{ \"test\": \"test\" }", "-1063294487", null, "USER" },
                    { -1, "UnitTest", new DateTime(2020, 9, 21, 22, 0, 32, 23, DateTimeKind.Local).AddTicks(7551), false, "UnitTestUser", "{ \"test\": \"test\" }", "-1063294487", null, "USER" }
                });
