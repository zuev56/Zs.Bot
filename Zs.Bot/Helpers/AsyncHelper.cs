...
namespace Zs.Bot.Helpers
{
    public static class AsyncHelpers
    {
        ...
        public static T RunSync<T>(Func<Task<T>> task)
        {
            ...
            using var newSyncContext = new ExclusiveSynchronizationContext();
            SynchronizationContext.SetSynchronizationContext(newSyncContext);
            T result = default;
            
            newSyncContext.Post(async _ =>
            {
                try
                {
                ...
                {
                    newSyncContext.InnerException = e;
                    throw;
                }
                finally
                {
                    newSyncContext.EndMessageLoop();
                }
            }, null);

            newSyncContext.BeginMessageLoop();
